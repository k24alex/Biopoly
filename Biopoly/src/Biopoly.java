...
public class Biopoly extends PApplet {
    ...
    /**
     * Stores if a person is able to get money again from question or free
     * money.
     */
    ...
    public void setup() {
        ...
        /**
         * Calls createGUI method that creates the buttons generated by G4P GUI
         * Builder
         */
        createGUI();
    ...
    public void handleButtonEvents(GButton button, GEvent event) {
        ...
        if (button == btnNextTurn) {
            ...
            /**
             * Makes sure that currentPlayer counter does not exceed total
             * number of players.
             */
            ...
            if (data[currentPlayer][3] == 1) {
                ...
                /**
                 * If getsMoney, at current location, and current player is
                 * true, check to see if the person landed on a question or free
                 * money square that gives user money for correct answer, to
                 * prevent infinite money exploit.
                 */
    ...
    public static void checkQuestion(int player, int location) {
        if ("question".equals(house[location][1])) {
            ...
            for (int i = 0; i < 2; i++) {
                ...
                /**
                 * If the random number is 1 (1/5 chance), ask multiple choice
                 * question, otherwise ask knowledge question
                 */
